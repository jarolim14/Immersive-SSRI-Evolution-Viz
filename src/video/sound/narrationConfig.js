...
const AUDIO_CONFIG = {
  ...
  sequences: {
    ...
    legend_panel_interaction_audio: "legend_panel_interaction_script.mp3",
    single_node_selection_audio: "single_node_selection_script.mp3",
    year_slider_adjusted_audio: "year_slider_adjusted_script.mp3",
    time_travel_animation_audio: "time_travel_animation_script.mp3",
    typing_in_search_bar_audio: "typing_in_search_bar_script.mp3",
    reset_button_clicked_audio: "reset_button_clicked_script.mp3",
  },
};
